...
// Simple device driver for the UART0.
// Daniel Valvano
// May 30, 2014
...
//------------UART_Init------------
// Initialize the UART for 4,608,000 baud rate (assuming 80 MHz UART clock),
...
void UART0_Init(void){
  ...
  UART0_CTL_R &= ~UART_CTL_UARTEN;      // disable UART
	UART0_CTL_R |= 0x20;
  UART0_IBRD_R = 86;                    	// IBRD = int(80,000,000 / (16 * 4,608,000)) = int(1.0850694) = 1
  UART0_FBRD_R = 52;                     // FBRD = int(0.0850694 * 64 + 0.5) = int(5.94) = 5
